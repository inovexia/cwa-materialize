...
// ** MUI Imports
import {
  Button, ButtonGroup, Box, Table, TableRow, TableBody, TableCell, TableHead,
  IconButton, Typography, TableContainer, TableSortLabel, TablePagination, Paper, Toolbar, Tooltip, Checkbox, Switch
} from '@mui/material'
...
// ** Actions Imports
import { DeleteCategoryComponent } from 'src/pages/qb/_models/CategoriesModel'
  ...
  return (
    <div>
      <ButtonGroup variant='outlined'>
        <Button href={`/qb?catId=${guid}`}>
          <Icon icon='mdi:eye-outline' fontSize={20} /> Questions
        </Button>
      </ButtonGroup>
      <ButtonGroup variant='outlined'>
        ...
        <Table sx={{ minWidth: 750 }} aria-labelledby='tableTitle'>
          ...
          <TableBody>
            ...
            {emptyRows > 0 && (
              ...
              >
                <TableCell colSpan={6}>
                  <Translations text={responseMessage} message='No categories found' />
                </TableCell>
              </TableRow>
            )}
          </TableBody>
