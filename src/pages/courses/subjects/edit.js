...
import FileUploaderSingle from '../_components/subjects/Fileupload'
...
const EditSubject = props => {
  ...
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <PageHeader
          title={<Typography variant='h5'>Edit Subject</Typography>}
          subtitle={<Typography variant='body2'>Edit your Subject</Typography>}
        />
      </Grid>
      <Grid item xs={12}>
        <Box sx={{ px: 4 }}>
