...
export default class MeetingApi {
  ...
  // Meeting list
  static meetingList = async guid => await ApiRequest(`course/zoom/get_meetings/${guid}`, 'POST')

  // Create Meeting
  static createMeeting = async ({ guid, data }) => await ApiRequest(`course/zoom/create_meeting/${guid}`, 'POST', { data })
