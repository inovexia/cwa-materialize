...
const EnhancedTable = (props) => {
  ...
  // ** Props
  const {rows, responseStatus, responseMessage, publishedStatus} = props
  ...
  const handleChangeStatus = ((event, guid) => {

    const response = changeStatus(event.target.checked, guid)
